                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xxl-6">
                            <div class="text-center my-5">
                                <h1 class="fw-bolder mb-3">Our Blog</h1>
                                <p class="lead fw-normal text-muted mb-4">Blog berita yang mencakup berbagai topik, sekaligus memenuhi
                tugas praktikum pemrograman website</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="py-5 bg-light">
                <div class="container px-5 my-5">
                    <div class="text-center">
                        ...
                        <p class="lead fw-normal text-muted mb-5">Pemrograman Web P07 - 2023</p>
                    </div>
